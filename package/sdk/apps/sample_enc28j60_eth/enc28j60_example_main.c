...
void user_init(void)
{
	...
	enc28j60_spi.pin_miso = 29;
	enc28j60_spi.pin_mosi = 6;
	enc28j60_spi.pin_cs = 28;
	enc28j60_spi.pin_sclk = 7;
#else
	gpio_int_pin = GPIO_10;
	enc28j60_spi.pin_miso = 12;
	enc28j60_spi.pin_mosi = 13;
	enc28j60_spi.pin_cs = 14;
	enc28j60_spi.pin_sclk = 15;
#endif
	enc28j60_spi.frame_bits = SPI_BIT8;
	enc28j60_spi.clock = 20000000;
	enc28j60_spi.mode = SPI_MODE0;
	enc28j60_spi.controller = SPI_CONTROLLER_SPI0;
	enc28j60_spi.irq_save_flag = 0;
	enc28j60_spi.isr_handler = NULL;
	...
	if (ethernet_init(&enc28j60_spi, addr, gpio_int_pin) != NRC_SUCCESS) {
